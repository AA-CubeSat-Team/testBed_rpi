...
void genReply(byte id){ 
  ...
  // 3 - clear last reset status
      // no reply
      byte rplArr3[7] = {0x7E, 0x03, 0x01, 0x58,0x7D,0x5D, 0x7E};
  // 4 - get reaction wheel status
      ...
      byte rplArr4[16] = {0x7E, 0x04, 0x01, 0x60,0xEA,0x00,0x00, 0xE8,0xFD,0x00,0x00, 0x04, 0x01, 0xF6,0xCF, 0x7E};
  // 5 - init reaction wheel controller
      // no reply
      byte rplArr5[6] = {0x7E, 0x05, 0x01, 0xF2,0xDB, 0x7E};
  // 6 - set ref speed
      // no reply
      byte rplArr6[6] = {0x7E, 0x06, 0x01, 0xA7,0x88, 0x7E};
  // 7 - set current limit control mode
      // no reply
      byte rplArr7[6] = {0x7E, 0x07, 0x01, 0x94,0xB9, 0x7E};
  // 8 - get temperature
      // int32_t
      byte rplArr8[10] = {0x7E, 0x08, 0x01, 0x9C,0xFF,0xFF,0xFF, 0xF2,0xC2, 0x7E};
  // 9 - get telemetry
      // lots of stuff
      // byte rplArr9[6] = {0x7E,0x09,0x01,crc,crc,0x7E};
  // 10 - ping
      // no reply
      byte rplArr10[6] = {0x7E, 0x0A, 0x01, 0xE2,0xE5, 0x7E};
